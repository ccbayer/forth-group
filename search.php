  ...
  <div class="container introduction-wrapper">
    <div class="row">
      <div class="col-md-10 offset-md-1 introduction">
        <h1 class="tk"><?= esc_html(get_field('search_title', 'option')); ?></h1>
        <?php if (!empty(get_field('search_introduction', 'option'))): ?>
          <div class="intro-copy">
            <p><?= esc_html(get_field('search_introduction', 'option')); ?></p>
          </div>
        <?php endif; ?>
      </div>
    </div>
