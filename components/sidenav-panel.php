                ...
                <div class="col-md-8">
                        ...
                        <?php
							for($i = 0; $i< $count; $i++) {
								...
								$class = $i === 0 ? 'active' : '';
							?>
              <a href="#content-<?php echo $n; ?>" class="tk responsive-tab-trigger <?php echo $class ?>"><?php echo $tabs[$i]['tab_label']; ?><span class="fa fa-chevron-right" aria-hidden="true"></span></a>
