    ...
    <div class="container">
        <div class="row">
        	<div class="col-md-12 lbl-wrapper">
        		<h2 class="h3"><?php the_field('bottom_cta_text'); ?></h2>
        	</div>
        	<div class="col-md-12 btn-wrapper">
            	<a class="btn tk" href="<?= $link; ?>" target=<?= $target ?>><?php the_field('bottom_cta_button_label'); ?> &raquo;</a>
							...
							?>
							<a class="btn tk" href="<?= $secondarylink; ?>" target=<?= $secondarytarget ?>>
                <?php the_field('secondary_bottom_cta_button_label'); ?> &raquo;
              </a>
							<?php
								endif;
							?>
