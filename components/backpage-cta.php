    ...
    <div class="container">
        <div class="row">
        	...
        	<div class="col-md-12 btn-wrapper">
            	<a class="btn tk" href="<?php echo $link; ?>" target=<?php echo $target ?>><?php the_field('bottom_cta_button_label'); ?> &raquo;</a>
							<?php
							...
							?>
							<a class="btn tk" href="<?php echo $secondarylink; ?>" target=<?php echo $secondarytarget ?>><?php the_field('secondary_bottom_cta_button_label'); ?> &raquo;</a>
							<?php
								endif;
							?>
        	</div>
