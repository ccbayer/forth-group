                ...
                <div class="col-md-4 side-nav">
	                ...
	                <?php
		                ...
		                for($i = 0; $i< $count; $i++) {
			                $n = $i + 1;
			                $class = $i === 0 ? 'active' : '';
							echo '<li class="'.$class.'"><a href="#content-'.$n.'" class="tab-switch tk">'.$tabs[$i]['faq_group_label'].'</a> <span class="fa fa-chevron-right" aria-hidden="true"></span></li>';
		                }
		                ?>
	                </ul>
                </div>
                <div class="col-md-8 col-sm-12 main-tab-content-wrapper">
                        ...
                        <?php
							for($i = 0; $i< $count; $i++) {
								...
								$class = $i === 0 ? 'active' : '';
							?>
                <a href="#content-<?php echo $n; ?>" class="tk tab-switch <?php echo $class ?>"><?php echo $tabs[$i]['faq_group_label']; ?><span class="fa fa-chevron-right" aria-hidden="true"></span></a>
